...
class CommentFixtures extends AbstractFixture implements OrderedFixtureInterface{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $comment = new Comment();
        $comment->setAuthor('someone');
        $comment->setComment('To make a long story short. You go wrong by choosing Symfony! And no one has ever been fired for using Symfony.');
